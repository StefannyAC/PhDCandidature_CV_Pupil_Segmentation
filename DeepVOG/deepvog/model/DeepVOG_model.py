...
def decoding_block(X, filter_size, filters_num, layer_num, block_type, stage, s = 1, X_jump = None, up_sampling = True):
    ...
    if X_jump is None or (isinstance(X_jump, int) and X_jump == 0):
        X_joined_input = X
    else:
